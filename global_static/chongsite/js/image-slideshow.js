...
************************************************************************************************************/
	...
	function startSlide(e)
	{
		...
		var id = this.id;
		this.getElementsByTagName('IMG')[0].src = '../../media/chong_site/portfolio/images/' + this.id + '_over.gif';
	...
	{
		var id = this.id;
		this.getElementsByTagName('IMG')[0].src = '../../media/chong_site/portfolio/images/' + this.id + '.gif';
		slideSpeed=0;
	}
